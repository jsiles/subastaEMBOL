...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
    <td width="15%" style="color:#ed1b21" align="left">Producto</td>
    <td width="15%" style="color:#ed1b21" align="left">Descripci&oacute;n</td>
    <td width="20%" style="color:#ed1b21" align="left">Imagen</td>
    <td width="10%" style="color:#ed1b21" align="left">Precio Base</td>
    <td width="15%" style="color:#ed1b21" align="left">Unidad de mejora</td>
	<td width="15%" style="color:#ed1b21" align="left">Proveedor</td> <td align="center" width="10%" height="5">&nbsp;</td>
...
if ($nroReg>0)
  ...
  <tr>
    ...
    <table class="list" width="100%">
	<tr>
    <td width="12%" style="color:#ed1b21">Producto</td>
    <td width="12%" style="color:#ed1b21">Descripci&oacute;n</td>
    <td width="12%" style="color:#ed1b21">Imagen</td>
    <td width="12%" style="color:#ed1b21">Precio base</td>
    <td width="12%" style="color:#ed1b21">Unidad de mejora</td>
	<td width="12%" style="color:#ed1b21">Proveedor</td>
