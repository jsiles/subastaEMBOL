...
<input name="usr_login" type="text" class="input" id="usr_login" size="60" onfocus="setClassInput(this,'ON');document.getElementById('div_usr_login').style.display='none';" onblur="setClassInput(this,'OFF');document.getElementById('div_usr_login').style.display='none';" onclick="setClassInput(this,'ON');document.getElementById('div_usr_login').style.display='none';" /><br /><span id="div_usr_login" style="display:none;" class="error">Usuario es necesario</span>			</td>
           ...
           <div id="pass_edit">
            ...
            <td width="64%">
<input name="usr_pass" type="password" class="input" id="usr_pass" size="60" onfocus="setClassInput(this,'ON');document.getElementById('div_usr_pass').style.display='none';" onblur="setClassInput(this,'OFF');document.getElementById('div_usr_pass').style.display='none';" onclick="setClassInput(this,'ON');document.getElementById('div_usr_pass').style.display='none';" /><br /><span id="div_usr_pass" style="display:none;" class="error">Password es necesario</span>			</td>
            <td width="7%">&nbsp;</td>
            </div>
          </tr>
		  <tr>
