<div id="content">
				...
				if (isset($uidCatgory)) $sWhere=" and pca_uid=$uidCatgory"; }else {
					...
					if($arrayURL[$urlPositionTitle]=='divisas') $sWhere=" and pca_uid=6";
						...
						$uidFirst=admin::getDbValue("SELECT TOP 1 distinct  a.pca_uid FROM mdl_pro_category a, mdl_subasta b where b.sub_pca_uid=a.pca_uid and b.sub_status='ACTIVE' order by pca_name");
