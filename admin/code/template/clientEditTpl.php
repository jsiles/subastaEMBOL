...
<input name="cli_user" type="text" class="input" id="cli_user" size="60" onfocus="setClassInput(this,'ON');document.getElementById('div_cli_user').style.display='none';" onblur="setClassInput(this,'OFF');document.getElementById('div_cli_user').style.display='none';" onclick="setClassInput(this,'ON');document.getElementById('div_cli_user').style.display='none';" value="<?=$regusers["cli_user"]?>" /><br /><span id="div_cli_user" style="display:none;" class="error">Usuario es necesario</span>			</td>
		   ...
		   <tr>
            ...
            <td width="64%"><span id="deltag"><?=trim(SymmetricCrypt::decrypt($regusers["cli_pass"]))?>&nbsp;<a href="#" onclick="removePass();return false;" title="Cambiar" class="small3">Cambiar</a></span>
<input name="cli_pass" style="display:none" type="text" class="input" id="cli_pass" size="60" onfocus="setClassInput(this,'ON');document.getElementById('div_cli_pass').style.display='none';" onblur="setClassInput(this,'OFF');document.getElementById('div_cli_pass').style.display='none';" onclick="setClassInput(this,'ON');document.getElementById('div_cli_pass').style.display='none';" value="<?=trim(SymmetricCrypt::decrypt($regusers["cli_pass"]))?>" /><br /><span id="div_cli_pass" style="display:none;" class="error">Password es necesario</span></td>
