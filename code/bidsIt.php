...
if($bidsCompra=='COMPRA')
{
	...
	elseif(round($monto_ofertado,2)>round($mayVal,2)) echo '<form name="formBids" class="formLabel">Su oferta '.$orig_monto_ofertado.'+ el factor de ajuste asciende a:'.$monto_ofertado.', introduzca una oferta mejor al monto mínimo:'.$mayVal.'<br><br><a href="Cerrar" onclick="$.facebox.close();return false;">Cancelar</a></form>';
	else {
