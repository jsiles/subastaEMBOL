...
<body>
<table width="100%">
<tr><td ><img src="'.$domain.'/lib/logo.png" width="100" /></td><td colspan="4"><h1>Reporte de Pujas</h1><br /><span>Fecha: '.date("d/m/Y").'</span></td></tr>
...
<tr><td colspan="5"><h2>3: Listado de pujas</h2></td></tr>
<tr><td><br /></td><td><br /></td></tr>
<tr><td colspan="5">
	<table width="100%">
    	<tr><th width="33%">Nombre de usuario:</th><th width="33%">Fecha y hora:</th><th width="33%">Monto:</th></tr>';
