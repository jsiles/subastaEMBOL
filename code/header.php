...
$imgs = admin::getDbValue("select top 1 ban_file from mdl_banners_contents, mdl_banners where mbc_delete=0  and mbc_ban_uid=ban_uid order by mbc_position ,mbc_ban_uid");
$ban_name = admin::getDbValue("select top 1 ban_title from mdl_banners_contents, mdl_banners where mbc_delete=0  and mbc_ban_uid=ban_uid order by mbc_position ,mbc_ban_uid");
...
<div id="top-header" class="container">
			...
			<div id="top-banner">
                ...
                <p style="text-align:left;padding-left:10px;vertical-align:top;"><?php
                    ...
                    <p style="text-align:left;padding-left:10px;vertical-align:top;"><a href="<?=$domain."/registro/".$uidClient."/"?>" class="viewcart">Cambiar</a></p>
