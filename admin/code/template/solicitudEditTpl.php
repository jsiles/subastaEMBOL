  ...
  <tr>
	...
	<tr>
        ...
        <tr>
            ...
            <td width="20%" ><input name="sol_observaciones" value="<?=$solEdit["sol_observaciones"]?>" class="input"></td>
            <td width="7%">&nbsp;</td>
        </tr>
        <tr>
	...
	?>
    <input name="sol_cli_uid[]" type="checkbox" value="<?=$value?>" size="9" <?=$selectUni?> /><?=$name?><br />
    <?php
        }
        }
        else{
