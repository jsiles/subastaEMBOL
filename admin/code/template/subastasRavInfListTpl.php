...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
	...
	if($valuePermit=='ACTIVE'){?>
            <a href="<?=admin::modulesLink('subastasRavInfNew')?>?token=<?=admin::getParam("token")?>"><?=admin::modulesLabels('subastasRavInfNew')?></a>
        <?php
        }
        ?>
        &nbsp;
...
while ($subasta_list = $pagDb->next_record())
	...
	<tr>
        ...
        <td width="11%" ><span><?=$rav_tipo?></span>
        <td width="11%" ><span><?=$rav_moneda?></span>
        	</td>
